import { r as registerInstance, k as createEvent, l as Build, h, j as getElement } from './index-7693580e.js';
...
import { l as assert, s as shallowEqualStringMap } from './helpers-bc25ace2.js';
import { l as lifecycle, L as LIFECYCLE_WILL_UNLOAD, a as LIFECYCLE_WILL_LEAVE, b as LIFECYCLE_DID_LEAVE, t as transition, s as setPageHidden } from './index-c29935cc.js';
...
let Nav = class {
  ...
  async componentDidLoad() {
    this.rootChanged();
    this.gesture = (await import('./swipe-back-391f541a.js')).createSwipeBackGesture(this.el, this.canStart.bind(this), this.onStart.bind(this), this.onMove.bind(this), this.onEnd.bind(this));
